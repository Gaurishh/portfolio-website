...
export const experiences = [
  ...
  },
  {
    ...
    bullets: [
      'Built a <strong>RAG-powered GenAI chatbot</strong> using <strong>FAISS Vector Database</strong> to answer internal queries by indexing <strong>100+</strong> wiki pages and PDFs, reducing documentation lookup time by <strong>70%</strong> and accelerating team onboarding by <strong>40%</strong>.',
