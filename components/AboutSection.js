         ...
         <div className="flex flex-col md:flex-row items-center mb-8">
             <div className="mb-8 md:mb-0 md:mr-10 flex-shrink-0">
                 ...
                 />
                   ...
                   <p className="text-gray-300 leading-relaxed mt-6 text-base md:text-lg">
                       When I&apos;m not coding, you&apos;ll usually find me exploring new technologies, competing in coding contests, or brainstorming product ideas that simplify everyday life.
                   </p>
        </div>
         </div>
