                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-10 px-6 md:px-12 max-w-7xl mx-auto w-full">
                    ...
                    <div className="space-y-6 max-w-2xl order-2 md:order-1">
                        ...
                        <p className="text-gray-400 text-lg leading-relaxed">
                            A high-agency engineer with strong problem-solving, product sense & experience shipping across the stack - specializing in building with LLMs.
                        </p>
                        <p className="text-gray-400 text-lg leading-relaxed">
                            Always excited to connect, learn and collaborate with other passionate builders!
                        </p>
                    ...
                    <div className="bg-gray-800/50 p-8 md:p-10 rounded-2xl border border-gray-700/50 shadow-xl backdrop-blur-sm">
                        <div className="flex flex-col md:flex-row gap-12 items-start">
                            ...
                            <div className="flex-1 space-y-6 text-lg text-gray-300 leading-relaxed">
                                ...
                                <p>
                                    I consider myself to be someone with a very strong bias for action. During my years at <strong>NIT Delhi</strong>, I've spent a lot of time tinkering with tech, solving real world problems, indulging in competitive programming, and exploring various CS domains through self-directed coursework.
                                </p>

                                <p>
                                    In general - I believe in working very hard and most importantly, have fun in doing that!
                                </p>
