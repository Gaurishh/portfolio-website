          ...
          <div className="flex flex-col xl:flex-row items-center mb-8">
              <div className="mb-8 xl:mb-0 xl:mr-10 flex-shrink-0">
                 ...
                 />
                   ...
                   <p className="text-gray-300 leading-relaxed mt-6 text-base md:text-lg">
                       When I&apos;m not working, you&apos;ll usually find me drinking coffee, staying up-to-date with startups and tech, learning something new, watching standup comedies or spending time out.
                   </p>
        </div>
         </div>
